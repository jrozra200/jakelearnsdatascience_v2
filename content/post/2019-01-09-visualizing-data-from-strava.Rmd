...
oauth_location <- "/Users/jrozra200/Documents/jakelearnsdatascience_v2/.httr-oauth"
```
...
Since `r min(info_df$start_date)`, I have - under my own power - traveled 
`r sum(info_df$miles)` miles. There were a few periods without much action 
(a whole year from mid-2016 through later-2017), which is a big sad. The last 
